...
namespace ESFA.DC.Web.Operations.Interfaces.PeriodEnd
{
    public interface IALLFPeriodEndService
    {
        ...
        Task<IEnumerable<FileUploadJobMetaDataModel>> GetSubmissionsForAllPeriodsAsync(int currentYear, int currentPeriod, CancellationToken cancellationToken = default(CancellationToken));

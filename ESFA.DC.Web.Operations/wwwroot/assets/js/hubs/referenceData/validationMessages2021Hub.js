class conditionOfFundingRemovalHub {
    ...
    constructor(controller) {
        ...
        this._connection = new signalR
            ...
            .withUrl("/validationMessages2021Hub", { transport: signalR.HttpTransportType.WebSockets }) 
            .build();
    }
    ...
    startHub() {
        this._connection.on("ReceiveMessage",
            (state) => { this._controller.renderFiles.call(this._controller, 'ValidationMessages2021' ,state) });

class devolvedPostcodesHub {
    ...
    constructor(controller) {
        ...
        this._connection = new signalR
            ...
            .withUrl("/devolvedPostcodesHub", { transport: signalR.HttpTransportType.WebSockets })
            .build();
    }
    ...
    startHub() {
        this._connection.on("ReceiveMessage",
            (state) => { this._controller.renderFiles.call(this._controller, 'DevolvedPostcodes', state) });
...
export default devolvedPostcodesHub;
class campusIdentifiersHub {
    ...
    constructor(controller) {
        ...
        this._connection = new signalR
            ...
            .withUrl("/campusIdentifiersHub", { transport: signalR.HttpTransportType.WebSockets })
            .build();
    }
    ...
    startHub() {
        this._connection.on("ReceiveMessage",
            (state) => { this._controller.renderFiles.call(this._controller, 'CampusIdentifiers', state) });
...
export default campusIdentifiersHub;
...
namespace ESFA.DC.Web.Operations.Services.FileValidation.ProviderPostcodeSpecialistResources
{
    public class ProviderPostcodeSpecialistResourceFileNameValidationService : AbstractFileNameValidationService
    {
        public ProviderPostcodeSpecialistResourceFileNameValidationService(
        ...
        protected override string FileNameFormat => "ProviderPostcodeSpecialistResourceRD-YYYYMMDDHHMM.csv";

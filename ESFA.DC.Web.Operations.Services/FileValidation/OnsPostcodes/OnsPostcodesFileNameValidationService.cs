...
namespace ESFA.DC.Web.Operations.Services.FileValidation.OnsPostcodes
{
    public class OnsPostcodesFileNameValidationService : AbstractFileNameValidationService
    {
        public OnsPostcodesFileNameValidationService(
        ...
        protected override string FileNameFormat => "ONSPD-YYYYMMDD.zip";

        protected override IEnumerable<string> FileNameExtensions => new List<string>() { ".ZIP" };

...
namespace ESFA.DC.Web.Operations.Services.FileValidation.FundingClaimsProviderData
{
    public class FundingClaimsProviderDataFileNameValidationService : AbstractFileNameValidationService
    {
        public FundingClaimsProviderDataFileNameValidationService(
        ...
        protected override string FileNameFormat => "FundingClaimsProviderDataRD-YYYYMMDDHHMM.csv";

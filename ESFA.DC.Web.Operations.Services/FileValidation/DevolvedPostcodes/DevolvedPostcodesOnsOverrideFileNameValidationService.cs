...
{
    public class DevolvedPostcodesOnsOverrideFileNameValidationService : AbstractFileNameValidationService
    {
        public DevolvedPostcodesOnsOverrideFileNameValidationService(
        ...
        protected override string FileNameFormat => "MCAGLA_ONSOverride_RD-YYYYMMDDHHMM.csv";

...
{
    public class DevolvedPostcodesFullNameFileNameValidationService : AbstractFileNameValidationService
    {
        public DevolvedPostcodesFullNameFileNameValidationService(
        ...
        protected override string FileNameFormat => "MCAGLA_FullName_RD-YYYYMMDDHHMM.csv";

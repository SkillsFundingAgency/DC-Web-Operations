...
{
    public class DevolvedPostcodesSofFileNameValidationService : AbstractFileNameValidationService
    {
        public DevolvedPostcodesSofFileNameValidationService(
        ...
        protected override string FileNameFormat => "MCAGLA_SOF_RD-YYYYMMDDHHMM.csv";

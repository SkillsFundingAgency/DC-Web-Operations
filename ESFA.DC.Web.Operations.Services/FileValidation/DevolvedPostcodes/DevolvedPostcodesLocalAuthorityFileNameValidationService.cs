...
namespace ESFA.DC.Web.Operations.Services.FileValidation.DevolvedPostcodes
{
    public class DevolvedPostcodesLocalAuthorityFileNameValidationService : AbstractFileNameValidationService
    {
        public DevolvedPostcodesLocalAuthorityFileNameValidationService(
        ...
        protected override string FileNameFormat => "MCAGLA_LocalAuthority_RD-YYYYMMDDHHMM.csv";

...
{
    public class JobFailedTodayService : IJobFailedTodayService
    {
        ...
        {
            return await _httpClientService.GetDataAsync($"{_baseUrl}/api/job/jobsthatarefailedtoday", cancellationToken);
        }
    }
}